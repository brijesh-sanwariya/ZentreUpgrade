...
const updateCategory = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      ...
      //Handle Error
      console.debug('Error-createCategory: ', error.response?.data)
      dispatch(LoadingController.setLoading({ loading: false }))
    }
  }
)
...
const createGoods = createAsyncThunk(
  ...
  async (params: {
    ...
    console.log('Creat-In-Goods', params)
    console.debug(accessToken)
    ...
    try {
      ...
      console.debug('Error-createCategory: ', error.response)
      console.debug('Error-createCategory: ', error.response?.data)
      console.debug('Error-createCategory: ', error.response?.data?.errors)
      dispatch(LoadingController.setLoading({ loading: false }))
    }
  }
)
